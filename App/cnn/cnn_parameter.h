...
#define CNN_RESOLUTION_WIDTH CONV1_IM_DIM
#define CNN_RESOLUTION_HEIGHT CONV1_IM_DIM
#define CNN_IMAGE_BUFFER_SIZE (CNN_RESOLUTION_WIDTH * CNN_RESOLUTION_HEIGHT * CONV1_IM_CH)
#define CNN_SCRATCH_BUFFER_SIZE (32*32*10*4)
#define CNN_COL_BUFFER_SIZE (64*5*5*2*2)
